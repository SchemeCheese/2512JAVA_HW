...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\nNhân viên Văn phòng");
        EmployeeOffice officeStaff = new EmployeeOffice("OFF01", "Nguyen Van A", "Ha Noi", 123456789, 22);
        officeStaff.display();

        System.out.println("\nNhân viên Kỹ thuật");
        EmployeeTechnical techStaff = new EmployeeTechnical("TEC01", "Tran Van B", "Da Nang", 987654321, 3);
        techStaff.display();

        System.out.println("\nNhân viên Bán hàng");
        EmployeeSales salesStaff = new EmployeeSales("SAL01", "Le Thi C", "HCM", 112233445, 500000000);
        salesStaff.display();
